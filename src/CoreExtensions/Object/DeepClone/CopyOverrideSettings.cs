...
namespace StandardDot.CoreExtensions.Object.DeepClone
{
	...
	{
		public CopyOverrideSettings(Type containingClassType, string affectedFieldName, T fieldValueOverride, bool shouldSkipOverrideInsteadOfSet,
			Type defaultPostActionType, bool useVistedGraph, bool onlyOverrideFirst = false, bool includeNonPublic = true,
			Dictionary<Type, Action<dynamic, dynamic, Type>> postCopyActions = null, List<string> fullNamesToSkip = null,
			List<string> fullNamesToInclude = null, List<string> fullNamesToAttempt = null)
			: base(containingClassType, affectedFieldName, fieldValueOverride, shouldSkipOverrideInsteadOfSet,
				defaultPostActionType, useVistedGraph, onlyOverrideFirst, includeNonPublic,
				postCopyActions, fullNamesToSkip,
				fullNamesToInclude, fullNamesToAttempt)
		{
